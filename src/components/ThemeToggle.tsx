...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="ml-2 flex p-1.5 items-center justify-center rounded-md bg-zinc-50 dark:bg-zinc-800 dark:bg-white/5 ring-1 ring-zinc-200 dark:ring-1 dark:ring-white/10"
